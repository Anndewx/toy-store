    ...
    <>
            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <li><Link className="dropdown-item active" to="/anime-figures">Anime Figures</Link></li>
                </ul>
              </li>
            </ul>
      ...
      <header className="bg-dark py-4">
        <div className="container px-4 px-lg-5 text-center text-white">
          <h1 className="display-4 fw-bolder mb-2">Anime Figures</h1>
          <p className="lead fw-normal text-white-50 mb-0">Epic Characters from Your Favorite Anime</p>
        </div>
      </header>
